...
$functions = [
    ...
    'bbbext_advgrd_probe_recording' => [
        ...
        'type'         => 'write',
        'ajax'         => true,
        'capabilities' => 'bbbext/advgrd:viewownreport',
    ],
    'bbbext_advgrd_get_library' => [
        'classname'    => 'bbbext_advgrd\\external\\get_library',
        'methodname'   => 'execute',
        'description'  => "List the caller's personal + course-shared library entries.",
        'type'         => 'read',
        'ajax'         => true,
        'capabilities' => 'bbbext/advgrd:grade',
    ],
    'bbbext_advgrd_save_library_comment' => [
        'classname'    => 'bbbext_advgrd\\external\\save_library_comment',
        'methodname'   => 'execute',
        'description'  => 'Persist a library entry (insert when itemid=0; update otherwise).',
        'type'         => 'write',
        'ajax'         => true,
        'capabilities' => 'bbbext/advgrd:grade',
    ],
    'bbbext_advgrd_delete_library_comment' => [
        'classname'    => 'bbbext_advgrd\\external\\delete_library_comment',
        'methodname'   => 'execute',
        'description'  => 'Delete a library entry owned by the caller.',
        'type'         => 'write',
        'ajax'         => true,
        'capabilities' => 'bbbext/advgrd:grade',
    ],
