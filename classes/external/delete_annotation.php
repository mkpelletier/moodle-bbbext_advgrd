...
/**
 * External function: delete an annotation (and its audio file, if any).
 *
...
/**
 * Removes one annotation. Capability check: the caller must hold bbbext/advgrd:grade in the
 * activity context AND either own the row (as grader) or hold the site-wide bypass to delete
 * others' comments. For v1 we keep it simple: any user with :grade can delete any annotation
