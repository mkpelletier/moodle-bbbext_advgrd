...
$string['annotate_audio_caption'] = 'Optional caption';
$string['annotate_audio_failed'] = 'Could not upload audio comment. Try again.';
$string['annotate_audio_mic_denied'] = 'Microphone permission is required to record audio comments.';
$string['annotate_audio_too_long'] = 'Audio comments are capped at 5 minutes.';
$string['annotate_body'] = 'Comment';
$string['annotate_category'] = 'Category';
$string['annotate_comments_heading'] = 'Existing comments';
$string['annotate_delete'] = 'Delete comment';
$string['annotate_failed'] = 'Could not load the annotation tab. Try refreshing the page.';
$string['annotate_loading'] = 'Loading annotation tab…';
$string['annotate_mode'] = 'Mode';
$string['annotate_no_comments'] = 'No comments yet for this recording.';
$string['annotate_no_playback'] = 'No playback URL is available for this recording yet. The recording may still be processing.';
$string['annotate_no_recordings'] = 'This BigBlueButton activity has no recordings yet.';
$string['annotate_post'] = 'Post comment';
$string['annotate_post_heading'] = 'Add a comment for {$a}';
$string['annotate_post_invalid'] = 'Enter a comment and a valid timestamp (mm:ss).';
$string['annotate_record'] = 'Record';
$string['annotate_recording_picker'] = 'Recording';
$string['annotate_seek_failed'] = 'Cannot seek into the BigBlueButton iframe. Open the recording in a separate tab and note the timestamp manually.';
$string['annotate_stop'] = 'Stop';
...
$string['annotation_category_correction'] = 'Correction';
$string['annotation_category_general'] = 'General';
$string['annotation_category_praise'] = 'Praise';
$string['annotation_category_question'] = 'Question';
$string['annotation_category_suggestion'] = 'Suggestion';
$string['annotation_emptybody'] = 'Annotation text cannot be empty.';
$string['annotation_kind_audio'] = 'Audio';
$string['annotation_kind_text'] = 'Text';
...
$string['privacy:metadata:bbbext_advgrd_annotation'] = 'Per-(recording, student) teacher feedback comments — text or audio — anchored to a position in the BigBlueButton recording.';
$string['privacy:metadata:bbbext_advgrd_annotation:body'] = 'The text of a text comment, or a short caption shown next to the audio play button for an audio comment.';
...
$string['privacy:metadata:bbbext_advgrd_annotation:graderid'] = 'The user (teacher) who authored the comment.';
$string['privacy:metadata:bbbext_advgrd_annotation:kind'] = 'Whether the comment is text or audio.';
$string['privacy:metadata:bbbext_advgrd_annotation:recordingid'] = 'The BigBlueButton recording the comment is anchored to.';
...
$string['privacy:metadata:bbbext_advgrd_audiocomment'] = 'Audio recordings authored by teachers and attached to feedback annotations. Stored in the standard Moodle file area; access controlled by the activity context.';
...
$string['tab_annotate'] = 'Annotate recording';
$string['tab_evidence'] = 'Engagement evidence';
