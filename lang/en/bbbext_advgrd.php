...
// Templates — shared groups (referenced from criteria descriptions; teachers can rename in the
// rubric editor at the cost of breaking analytic-mode group inference for those criteria).
...
// Template: Community of Inquiry (revised, single-session focus).
...
// CoI criteria + level descriptors.
...
// Template: Inclusive multi-modal participation.
...
// Mapping table columns and metric labels.
...
// Analytic-mode gradebook item names — {$a->presence} and {$a->activity} substituted at runtime.
